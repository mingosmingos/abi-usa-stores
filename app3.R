...
# ============================================================================
# GA para O1 - EXATAMENTE IGUAL AO SCRIPT (maxiter = 150)
# ============================================================================
...
run_ga_O1 <- function(week_id, popSize = 100, maxiter = 100, 
  ...
  fitness_fn <- function(sol) {
    ...
    if(is.na(profit) || !is.finite(profit)) return(-1e9)
    return(profit)
  }
  ...
  ga_result <- ga(
    ...
    pmutation = pmutation,
    elitism = elitism,
    run = maxiter,  # <-- MUDAR: run = maxiter (não 50)
    monitor = FALSE,  # FALSE para não poluir app
    seed = 123
  )
